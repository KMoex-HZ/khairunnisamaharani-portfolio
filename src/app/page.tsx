...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen">
      ...
      <section className="px-4 md:px-8 pt-5" id="projects">
        {" "}
        {/* Gunakan ID 'projects' */}
        <MotionH2
      ...
      <section
        className="py-20 pt-25 px-4 md:px-8 bg-gradient-to-br from-slate-50 to-blue-50"
        id="certificates"
      >
        {/* Header */}
        <div className="text-center mb-16">
          ...
          >
            Certifications and achievements that highlight my commitment to
            lifelong learning in data science, programming, and design.
          </motion.p>
        </div>
      ...
      <section className="py-20 px-4 md:px-8 pt-25" id="publications">
        <div className="text-center mb-3">
          ...
          <motion.p
            ...
            className="text-lg text-gray-600 max-w-2xl mx-auto"
          >
            A curated selection of peer-reviewed articles and research
            showcasing my work in AI, data science, and technology.
          </motion.p>
        </div>
            ...
            <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
              ...
              <div className="text-base !m-0 !p-0 font-normal">
                <span className="text-gray-500 ">
                  Peer-reviewed article on AI website training, published in a
                  nationally accredited (SINTA 2) journal.
                </span>
              </div>
      ...
      <section
        className="py-10 px-4 md:px-8 bg-gradient-to-br from-slate-50 to-blue-50"
        id="contact"
      >
