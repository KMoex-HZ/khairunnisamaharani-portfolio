      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            I&apos;m always open to opportunities, collaboration, or simply a
            chat.
          </p>
        </div>
        ...
        {/* Main Content */}
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-start transition-opacity duration-1000 ${
            hasAnimated
          ...
          <div className="space-y-6">
            ...
            {socialLinks.map((social, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${social.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
                />

                {/* Content */}
                <div className="relative flex items-center space-x-4">
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r ${social.gradient} rounded-xl text-white shadow-lg`}
                  >
                    {social.icon}
                  </div>
                ...
                {/* Bottom border */}
                <div
                  className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${social.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`}
                />
              </a>
            ))}
          </div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Whether it&apos;s a data science project, web development, or
              design work, I&apos;d love to hear about your ideas and see how we
              can work together.
            </p>
