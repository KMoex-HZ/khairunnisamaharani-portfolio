                ...
                {filteredProjects.map((proj, i) => (
                  <div
                    ...
                    className={`relative group overflow-hidden flex-shrink-0 ${
                      isMobile ? "w-[210px]" : "w-[300px]"
                    } min-h-[500px] p-6 rounded-2xl bg-white border border-gray-200 shadow-lg transform transition-all duration-300 hover:shadow-xl hover:scale-102 mb-2`}
                    title={proj.tooltip}
                  >
                    {/* Meta Info Header */}
