export const projects = [
  {
    title: "Emotion Classification – Big Data Challenge 2025",
    desc: "Built a robust emotion classification model from video data for the Big Data Challenge (BDC) Satria Data 2025 competition. The project used a multimodal approach by combining features from audio (Librosa), visual (ResNet50), and text (IndoBERT) extracted from videos. An XGBoost model was used for the classification, achieving high performance (F1 Macro ~0.876) despite challenges with emotionally similar classes like 'Proud,' 'Surprise,' and 'Trust'.",
    img: "/images/projects/p17.png",
    button: "GitHub",
    category: "Data",
    year: "2025",
    status: "Finished",
    ...
    preview: "https://github.com/KMoex-HZ/Emotion_Multimodal_BDC",
    docs: "https://github.com/KMoex-HZ/Emotion_Multimodal_BDC",
    tooltip:
      "Multimodal emotion classification model using XGBoost on video data",
  },
  {
    title: "Cost Effective Data Pipelines",
    desc: "A learning project on data pipelines from Joseph Machado's repository. Utilized Python and DuckDB to build an efficient ETL (Extract, Transform, Load) process on TPC-H data. This project focuses on processing large datasets with a cost-effective approach.",
    img: "/images/projects/p16.png",
    button: "GitHub",
    category: "Data",
    year: "2025",
    status: "Ongoing",
    ...
    preview: "https://github.com/KMoex-HZ/cost_effective_data_pipelines",
    docs: "https://github.com/KMoex-HZ/cost_effective_data_pipelines",
    tooltip:
      "Learning data pipelines from Joseph Machado using Python and DuckDB",
  },
  {
